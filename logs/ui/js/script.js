...
var searchAwnsers = [];
  ...
  function updateHomeStats(id, value) {
    ...
    if(id==1) {
      $("#kills").replaceWith('<div class="statsBlock" id="kills"><p id="sTitle">'+value+'</p><p id="sDesc">Deaths</p></div>');
    }else if(id==2) {
      $("#PoliceVehicles").replaceWith('<div class="statsBlock" id="PoliceVehicles"><p id="sTitle">'+value+'</p><p id="sDesc">use of police vehicle</p></div>');
    }else if(id==3) {
      $("#blVehicules").replaceWith('<div class="statsBlock" id="blVehicules"><p id="sTitle">'+value+'</p><p id="sDesc">used blacklisted vehicles</p></div>');
    }else if(id==4) {
      $("#blWeapons").replaceWith('<div class="statsBlock" id="blWeapons"><p id="sTitle">'+value+'</p><p id="sDesc">used blacklisted weapons</p></div>');
    }
